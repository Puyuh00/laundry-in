...
<head>
    ...
    if (isset($_GET['nama'])) {
        $nama = $_GET['nama'];
        echo "Nama Karyawan: " . $_GET['nama']; 
       

        // Ambil data pengguna berdasarkan role dari database
        $query = "SELECT nama, username, password FROM pengguna WHERE role = 'Karyawan' AND nama = '$nama'";         
        ...
        if (mysqli_num_rows($result) == 1) {
            ...
            if (isset($_POST['simpan'])) {
                ...
                if (!empty( $nama) && !empty( $username) && !empty($password )) {
                    ...
                    $update_query = "UPDATE pengguna SET nama = '$nama', username = '$username', password = '$password' WHERE role = 'Karyawan' AND nama = '$nama'";
                    $update_result = mysqli_query($koneksi, $update_query);

                    if ($update_result) {
                        // Set session untuk alert berhasil
                        $_SESSION['success_message'] = "Profil karyawan berhasil diedit.";
            ...
            echo "Profil karyawan tidak ditemukan.";
            exit();
        }
    } else {
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <ol class="breadcrumb pull-right">
                                    <li><a href="profil.php">Profil karyawan</a></li>
                                    <li class="active">Edit Profil Karyawan</li>
                                </ol>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="panel panel-border panel-dark">
                                <div class="panel-heading">
                                    <h3 class="panel-title ion-md-create"> Edit Profil Karyawan</h3>
                                </div>
                                <div class="panel-body">
                                    <div class="form">
                                        <form method="POST" action="edit_profil.php?nama=<?= $nama ?>" class="cmxform form-horizontal tasi-form">                              
