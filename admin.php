...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $id_pengguna = $id_admin + 3;
    $nama = $nama_admin;
    $username = $_POST['username'];
    $password = $_POST['password'];

    // Query SQL untuk menambahkan data ke tabel admin
    $sql = "INSERT INTO admin(id_admin, nama_admin, alamat, no_telepon) 
           VALUES (' $id_admin', '$nama_admin', '$alamat', '$no_telepon')";

    $sql2 = "INSERT INTO pengguna(id_pengguna, nama, username, password, role)
            VALUES ('$id_pengguna', '$nama', '$username', '$password', 'Admin')";
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-border panel-primary">
                                <div class="panel-heading">
                                    <h3 class="panel-title ion-md-contacts"> Data Admin</h3>
                                </div>
                                <div>
                                    <a href="tambah_admin.php" class="btn btn-primary m-l-15 m-t-15 ion-md-add"> Tambah Admin</a>
                                </div>
                                <div class="panel-body">
                                    ...
                                    ?>
                                    <table id="admin" class="table table-striped">
                                        <thead>
                                            <tr>
                                                <th>No</th>
                                                <th>ID Admin</th>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-success ion-md-create m-r-5" href="edit_admin.php?id_admin=<?= $row['id_admin'] ?>"> Edit</a>
                                                        <a class="btn btn-danger ion-md-trash" href="hapus_admin.php?id_admin=<?= $row['id_admin'] ?>"> Hapus</a>
