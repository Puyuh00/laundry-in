                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-border panel-primary">
                                <div class="panel-heading">
                                    <h3 class="panel-title ion-ios-clipboard"> Data Pesanan</h3>
                                </div>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                ...
                                                <td><?= $i ?></td>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-success ion-md-create m-r-5" href="edit_pesanan.php?id_pesanan=<?= $row['id_pesanan'] ?>"> Edit</a>
                                                        <a class="btn btn-danger ion-md-trash" href="hapus_pesanan.php?id_pesanan=<?= $row['id_pesanan'] ?>"> Hapus</a>
                                                    </td>
