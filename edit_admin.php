...
<head>
    ...
    if (isset($_GET['id_admin'])) {
        ...
        echo "ID Admin: " . $_GET['id_admin'];

        // Ambil data admin berdasarkan id_admin dari database
        ...
        if (mysqli_num_rows($result) == 1) {
            ...
            if (isset($_POST['simpan'])) {
                ...
                if (!empty( $nama_admin) && !empty($alamat ) && !empty($no_telepon)) {
                    // Update data admin dalam database
                    $update_query = "UPDATE admin SET nama_admin = '$nama_admin', alamat = '$alamat ', no_telepon = '$no_telepon' WHERE id_admin = '$id_admin'";
                    $update_result = mysqli_query($koneksi, $update_query);

                    if ($update_result) {
                        // Set session untuk alert berhasil
                        $_SESSION['success_message'] = "Data admin berhasil diedit.";
                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="has_sub">
                                <a href="#" class="waves-effect"><i class="ion-md-person"></i> <span>Pengguna</span> <span class="pull-right"><i class="ion-ios-arrow-down"></i></span></a>                             
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-border panel-primary">
                                <div class="panel-heading">
                                    <h3 class="panel-title ion-md-create"> Edit Data Admin</h3>
                                </div>
                                <div class="panel-body">
                                    <div class="form">
                                        <form method="POST" action="edit_admin.php?id_admin=<?= $id_admin ?>" class="cmxform form-horizontal tasi-form">
                                            <div class="form-group">
                                                <label class="control-label col-lg-2" for="nama_admin"> Nama Admin :</label>
                                                <div class="col-lg-5">
