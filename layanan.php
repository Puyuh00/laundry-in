...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO layanan(id_layanan, nama_layanan, biaya, deskripsi) 
           VALUES (' $id_layanan', '$nama_layanan', '$biaya', '$deskripsi')";
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-border panel-primary">
                                <div class="panel-heading">
                                    <h3 class="panel-title ion-ios-shirt"> Data Layanan</h3>
                                </div>
                                <div>
                                    <a href="tambah_layanan.php" class="btn btn-primary m-l-15 m-t-15 ion-md-add"> Tambah Layanan</a>
                                </div>
                                <div class="panel-body">
                                    ...
                                    ?>
                                    <table id="layanan" class="table table-striped">
                                        <thead>
                                            <tr>
                                                <th>No</th>
                                                <th>ID Layanan</th>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?= $row['deskripsi'] ?></td>
                                                    <td>
                                                        <a class="btn btn-success ion-md-create m-r-5" href="edit_layanan.php?id_layanan=<?= $row['id_layanan'] ?>"> Edit</a>
                                                        <a class="btn btn-danger ion-md-trash" href="hapus_layanan.php?id_layanan=<?= $row['id_layanan'] ?>"> Hapus</a>
