...
<head>
    ...
    if (isset($_GET['id_karyawan'])) {
        ...
        echo "ID Karyawan: " . $_GET['id_karyawan'];

        // Ambil data karyawan berdasarkan id_karyawan dari database
        ...
        if (mysqli_num_rows($result) == 1) {
            ...
            if (isset($_POST['simpan'])) {
                ...
                if (!empty( $nama_karyawan ) && !empty($alamat ) && !empty($no_telepon)) {
                    // Update data karyawan dalam database
                    $update_query = "UPDATE karyawan SET nama_karyawan = '$nama_karyawan', alamat = '$alamat ', no_telepon = '$no_telepon' WHERE id_karyawan = '$id_karyawan'";
                    $update_result = mysqli_query($koneksi, $update_query);

                    if ($update_result) {
                        // Set session untuk alert berhasil
                        $_SESSION['success_message'] = "Data karyawan berhasil diedit.";

                        // Redirect ke halaman karyawan setelah berhasil melakukan pengeditan
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-border panel-primary">
                                <div class="panel-heading">
                                    <h3 class="panel-title ion-md-create"> Edit Data Karyawan</h3>
                                </div>
                                <div class="panel-body">
                                    <div class="form">
                                        <form method="POST" action="edit_karyawan.php?id_karyawan=<?= $id_karyawan ?>" class="cmxform form-horizontal tasi-form">
                                            <div class="form-group">
                                                <label class="control-label col-lg-2" for="nama_karyawan"> Nama Karyawan :</label>
                                                <div class="col-lg-5">
