...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Query SQL untuk menambahkan data ke tabel pelanggan
    $sql = "INSERT INTO pelanggan (id_pelanggan, nama_pelanggan, alamat, no_telepon) 
           VALUES (' $id_pelanggan', '$nama_pelanggan ', '$alamat', '$no_telepon')";
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="col text-center m-t-10">
                                    <a href="pesanan.php" class="btn btn-primary btn-rounded end">Proses Pesanan</a>
                                </div>
