                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-border panel-primary">
                                <div class="panel-heading">
                                    <h3 class="panel-title ion-ios-person"> Data Pelanggan</h3>
                                </div>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-success ion-md-create m-r-5" href="edit_pelanggan.php?id_pelanggan=<?= $row['id_pelanggan'] ?>"> Edit</a>
                                                        <a class="btn btn-danger ion-md-trash" href="hapus_pelanggan.php?id_pelanggan=<?= $row['id_pelanggan'] ?>"> Hapus</a>
