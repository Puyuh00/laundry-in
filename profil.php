                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-border panel-dark">
                                <div class="panel-heading">
                                    <h3 class="panel-title ion-md-contact"> Profil Karyawan</h3>
                                </div>                               
                                ...
                                <?php
                                    ...
                                    <table id="profil" class="table table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                            $query = "SELECT nama, username, password FROM pengguna WHERE role = 'Karyawan'";                                           
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?= $row['password'] ?></td>                                                   
                                                    <td>
                                                        <a class="btn btn-success ion-md-create m-r-5" href="edit_profil.php?nama=<?= $row['nama'] ?>"> Edit</a>                                                      
                                                    </td>
