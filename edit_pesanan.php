    ...
    if (isset($_GET['id_pesanan'])) {
        ...
        if (mysqli_num_rows($result) == 1) {
            ...
            if (isset($_POST['simpan'])) {
                ...
                if (!empty($layanan) && !empty($berat) && !empty($total_biaya)&& !empty($tanggal_masuk)&& !empty($tanggal_keluar)) {
                    // Update data pesanan dalam database
                    $update_query = "UPDATE pesanan SET layanan = '$layanan', berat = '$berat', total_biaya = '$total_biaya', tanggal_masuk = '$tanggal_masuk', tanggal_keluar = '$tanggal_keluar' WHERE id_pesanan = '$id_pesanan'";
                    $update_result = mysqli_query($koneksi, $update_query);

                    if ($update_result) {
                        // Set session untuk alert berhasil
                        $_SESSION['success_message'] = "Data pesanan berhasil diedit.";

                        // Redirect ke halaman data pesanan setelah berhasil melakukan pengeditan
                        ...
                        <ul>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    <li><a class='ion-md-contacts' href="admin"> Data Admin</a></li>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <ol class="breadcrumb pull-right">
                                    <li><a href="admin_pembayaran.php">Pesanan</a></li>
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-border panel-primary">
                                <div class="panel-heading">
                                    <h3 class="panel-title ion-ios-clipboard"> Edit Data Pesanan</h3>
                                </div>
                                <div class="panel-body">
                                    <div class="form">
                                        <form method="POST" action="edit_pesanan.php?id_pesanan=<?= $id_pesanan ?>" class="cmxform form-horizontal tasi-form">
                                            <div class="form-group">
                                                <label class="control-label col-lg-2" for="layanan"> Layanan :</label>
                                                <div class="col-lg-5">
                                                    <input type="text" class="form-control" name="layanan" value="<?= $row['layanan'] ?>" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-lg-2" for="berat"> Berat (Kg) :</label>
                                                <div class="col-lg-5">
                                                    <input type="text" class="form-control" name="berat" value="<?= $row['berat'] ?>" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-lg-2" for="berat"> Total Biaya :</label>
                                                <div class="col-lg-5">
                                                    <input type="text" class="form-control" name="total_biaya" value="<?= $row['total_biaya'] ?>" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-lg-2" for="tanggal_masuk"> Tanggal Masuk :</label>
                                                <div class="col-lg-5">
                                                    <input type="text" class="form-control" name="tanggal_masuk" value="<?= $row['tanggal_masuk'] ?>" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-lg-2" for="tanggal_keluar"> Tanggal Keluar :</label>
                                                <div class="col-lg-5">
                                                    <input type="text" class="form-control" name="tanggal_keluar" value="<?= $row['tanggal_keluar'] ?>" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
