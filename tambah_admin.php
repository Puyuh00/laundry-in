                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-border panel-primary">
                                <div class="panel-heading">
                                    <h3 class="panel-title ion-md-add"> Tambah Admin</h3>
                                </div>
                                <div class="panel-body">
                                    <div class="form">
                                        <form method="POST" action="admin.php" enctype="multipart/form-data" class="cmxform form-horizontal tasi-form" id="commentForm">
                                            <div class="form-group">
                                                <label class="control-label col-lg-2">ID Admin :</label>
                                                <div class="col-lg-5">
                                                    <input type="text" class="form-control" name="id_admin" id="admin" placeholder="Masukan ID Admin" required autocomplete="off">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-lg-2">Nama Admin :</label>
                                                <div class="col-lg-5">
                                                    <input type="text" class="form-control" name="nama_admin" id="nama" placeholder="Masukan Nama Admin" required autocomplete="off">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <div class="col-lg-offset-5 col-lg-10">
                                                    <input type="submit" name="kirim" value="Tambah Admin" class="btn-primary btn-rounded">
                                                </div>
                                            </div>
                                        </form>
