...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $id_pengguna = $id_karyawan + 2;
    $nama = $nama_karyawan;
    $username = $_POST['username'];
    $password = $_POST['password'];

    // Query SQL untuk menambahkan data ke tabel karyawan
    $sql = "INSERT INTO karyawan(id_karyawan, nama_karyawan, alamat, no_telepon) 
            VALUES ('$id_karyawan', '$nama_karyawan', '$alamat', '$no_telepon')";

    $sql2 = "INSERT INTO pengguna(id_pengguna, nama, username, password, role)
             VALUES ('$id_pengguna', '$nama', '$username', '$password', 'Karyawan')";
    ...
    if (mysqli_query($koneksi, $sql)) {
        ...
        if (mysqli_query($koneksi, $sql2)) {
            ...
            echo "Gagal menyimpan data pengguna: " . mysqli_error($conn);
        }                                           
    } else {
...
<head>
    ...
    <style>
        .dataTables_filter input {
            width: 100%;
            /* Atur lebar pencarian menjadi 100% dari elemen induknya */
            box-sizing: border-box;
            /* Pastikan lebar termasuk padding dan border */
            max-width: 150px;
            /* Atur lebar maksimum sesuai dengan batas panel body */
        }
    </style>
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-border panel-primary">
                                <div class="panel-heading">
                                    <h3 class="panel-title ion-md-contacts"> Data Karyawan</h3>
                                </div>
                                <div>
                                    <a href="tambah_karyawan.php" class="btn btn-primary m-l-15 m-t-15 ion-md-add"> Tambah Karyawan</a>
                                </div>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-success ion-md-create m-r-5" href="edit_karyawan.php?id_karyawan=<?= $row['id_karyawan'] ?>"> Edit</a>
                                                        <a class="btn btn-danger ion-md-trash" href="hapus_karyawan.php?id_karyawan=<?= $row['id_karyawan'] ?>"> Hapus</a>
