                        ...
                        <div class="user-info">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="profil.php"><i class="ion-md-contact"></i> Profil<div class="ripple-wrapper"></div></a>
                                    </li>
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-border panel-dark">
                                <div class="panel-heading">
                                    <h3 class="panel-title ion-ios-clipboard"> Riwayat Pesanan</h3>
                                </div>
                                <div class="panel-body">
                                    <table id="data_pesanan" class="table table-striped">
                                        <thead>
                                            <tr>
                                                <th>No</th>
                                                <th>ID Pesanan</th>                                                
                                        ...
                                        <tbody>
                                            <?php
                                            $query = "SELECT id_pesanan, layanan, berat, total_biaya, tanggal_masuk, tanggal_keluar FROM pesanan";                                                                             
