...
<head>
    ...
    if (isset($_GET['id_layanan'])) {
        ...
        echo "ID Layanan: " . $_GET['id_layanan'];

        // Ambil data layanan berdasarkan id_layanan dari database
        ...
        if (mysqli_num_rows($result) == 1) {
            ...
            if (isset($_POST['simpan'])) {
                ...
                if (!empty( $nama_layanan ) && !empty($biaya) && !empty($deskripsi)) {
                    // Update data layanan dalam database
                    $update_query = "UPDATE layanan SET nama_layanan = '$nama_layanan', biaya = '$biaya ', deskripsi = '$deskripsi' WHERE id_layanan = '$id_layanan'";
                    $update_result = mysqli_query($koneksi, $update_query);

                    if ($update_result) {
                        // Set session untuk alert berhasil
                        $_SESSION['success_message'] = "Data layanan berhasil diedit.";

                        // Redirect ke halaman layanan setelah berhasil melakukan pengeditan
                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li><a href="#" class="waves-effect"><i class="ion-ios-book"></i><span> Laporan</span></a></li>
                        </ul>
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-border panel-primary">
                                <div class="panel-heading">
                                    <h3 class="panel-title ion-ios-shirt"> Edit Data Layanan</h3>
                                </div>
                                <div class="panel-body">
                                    <div class="form">
                                        <form method="POST" action="edit_layanan.php?id_layanan=<?= $id_layanan ?>" class="cmxform form-horizontal tasi-form">
                                            <div class="form-group">
                                                <label class="control-label col-lg-2" for="nama_layanan"> Nama Layanan :</label>
                                                <div class="col-lg-5">
                                                    <input type="text" class="form-control" name="nama_layanan" value="<?= $row['nama_layanan'] ?>" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-lg-2" for="biaya"> Biaya (Rp) / Kg :</label>
                                                <div class="col-lg-5">
