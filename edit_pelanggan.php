...
<head>
    ...
    if (isset($_GET['id_pelanggan'])) {
        ...
        echo "ID Pelanggan: " . $_GET['id_pelanggan'];

        // Ambil data pelanggan berdasarkan id_pelanggan dari database
        ...
        if (mysqli_num_rows($result) == 1) {
            ...
            if (isset($_POST['simpan'])) {
                ...
                if (!empty( $nama_pelanggan ) && !empty($alamat ) && !empty($no_telepon)) {
                    // Update data pelanggan dalam database
                    $update_query = "UPDATE pelanggan SET nama_pelanggan = '$nama_pelanggan', alamat = '$alamat ', no_telepon = '$no_telepon' WHERE id_pelanggan = '$id_pelanggan'";
                    $update_result = mysqli_query($koneksi, $update_query);

                    if ($update_result) {
                        // Set session untuk alert berhasil
                        $_SESSION['success_message'] = "Data pelanggan berhasil diedit.";

                        // Redirect ke halaman admin pelanggan setelah berhasil melakukan pengeditan
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <ol class="breadcrumb pull-right">
                                    <li><a href="admin_pelanggan.php">Pelanggan</a></li>
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-border panel-primary">
                                <div class="panel-heading">
                                    <h3 class="panel-title ion-ios-person"> Edit Data Pelanggan</h3>
                                </div>
                                <div class="panel-body">
                                    <div class="form">
                                        <form method="POST" action="edit_pelanggan.php?id_pelanggan=<?= $id_pelanggan ?>" class="cmxform form-horizontal tasi-form">
                                            <div class="form-group">
                                                <label class="control-label col-lg-2" for="nama_pelanggan"> Nama Pelanggan :</label>
                                                <div class="col-lg-5">
                                                    <input type="text" class="form-control" name="nama_pelanggan" value="<?= $row['nama_pelanggan'] ?>" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-lg-2" for="alamat"> Alamat :</label>
                                                <div class="col-lg-5">
                                                    <input type="text" class="form-control" name="alamat" value="<?= $row['alamat'] ?>" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-lg-2" for="no_telepon">No.Telepon :</label>
                                                <div class="col-lg-5">
