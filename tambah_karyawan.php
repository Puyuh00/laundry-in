                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-border panel-primary">
                                <div class="panel-heading">
                                    <h3 class="panel-title ion-md-add"> Tambah Karyawan</h3>
                                </div>
                                <div class="panel-body">
                                    <div class="form">
                                        <form method="POST" action="karyawan.php" enctype="multipart/form-data" class="cmxform form-horizontal tasi-form" id="commentForm">
                                            <div class="form-group">
                                                <label class="control-label col-lg-2">ID Karyawan :</label>
                                                <div class="col-lg-5">
                                                    <input type="text" class="form-control" name="id_karyawan" id="karyawan" placeholder="Masukan ID Karyawan" required autocomplete="off">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-lg-2">Nama Karyawan :</label>
                                                <div class="col-lg-5">
                                                    <input type="text" class="form-control" name="nama_karyawan" id="nama" placeholder="Masukan Nama Karyawan" required autocomplete="off">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-5">
                                                    <input type="text" class="form-control" name="no_telepon" id="no_telepon" placeholder="Masukan No.Telepon" required autocomplete="off">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <div class="col-lg-offset-5 col-lg-10">
                                                    <input type="submit" name="kirim" value="Tambah Karyawan" class="btn-primary btn-rounded">
                                                </div>
                                            </div>
                                        </form>
